...
export const LIST_MOCK: IResult[] = [
  { name: 'uuid', url: 'uuid', like: true },
  { name: 'uuid2', url: 'uuid', like: false },
  { name: 'uuid3', url: 'uuid', like: false },
  { name: 'uuid4', url: 'uuid', like: false },
  { name: 'uuid5', url: 'uuid', like: false },
  { name: 'uuid6', url: 'uuid', like: false },
];

export const POKEMON_MOCK: IResult = {
  name: 'uuid',
  url: 'uuid',
  like: true,
};
